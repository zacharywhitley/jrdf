...
public class NaiveGraphDecomposerImpl implements GraphDecomposer {
    ...
    private SortedSet<Molecule> molecules;
    private Graph graph;
    private Triple currentTriple;

    public NaiveGraphDecomposerImpl(TripleComparator newComparator) {
        this.comparator = newComparator;
    }

    public SortedSet<Molecule> decompose(Graph graph) throws GraphException, MoleculeInsertionException {
        this.graph = graph;
        triplesChecked.clear();
        molecules = new TreeSet<Molecule>(new HeadTripleMoleculeComparator(comparator));
    ...
    private void addTriplesWithBlankNodes() throws GraphException, MoleculeInsertionException {
        boolean blankSubject = isBlankNode(currentTriple.getSubject());
        boolean blankObject = isBlankNode(currentTriple.getObject());
        Molecule molecule = new MoleculeFactoryImpl(comparator).createMolecule(currentTriple);
